...
const ClosedBids: React.FC = () => {
    ...
    return (
        <div className="p-6">
            <div className='mb-5'>
                <h1 className="text-4xl font-thin tracking-tighter text-white">Closed Bids</h1>
                <p className='font-thin text-white'>The table provides comprehensive information on all closed bids.</p>
            </div>
                        ...
                        <tbody>
                            {slips.map((slip) => (
                                <tr key={slip._id} className='bg-black'>
                                    ...
                                    <td className="py-3 px-4 text-sm text-gray-400">
                                        <button
                                            className="px-4 py-2 rounded hover:bg-[#3C2A21] transition-colors duration-500"
            ...
            {isModalOpen && selectedSlip && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white text-black rounded-lg shadow-lg w-full max-w-md mx-4 p-6">
                        {/* <h2 className="text-lg font-bold">Slip Details</h2> */}
                        <div className="grid gap-4 py-4">
                            <div>
                                <p className='text-green-500'>WINNER BIDDER: {selectedSlip.user.name}</p>
                                <p>WINNER EMAIL: {selectedSlip.user.email}</p>
                            </div>
                            <div>
                                <p className='mb-2 text-blue-500'>Details for the bid items</p>
