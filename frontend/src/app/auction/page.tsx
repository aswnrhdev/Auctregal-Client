...
const Page = () => {
  ...
  useEffect(() => {
    Promise.all([
      fetch('https://auctregal.rudopedia.shop/items/upcoming').then(res => res.json()),
      fetch('https://auctregal.rudopedia.shop/items/bidding').then(res => res.json()),
      fetch('https://auctregal.rudopedia.shop/items/closed').then(res => res.json())
    ]).then(() => {
      setLoading(false)
    }).catch(error => {
