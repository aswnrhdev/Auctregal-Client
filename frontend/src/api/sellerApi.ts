...
export const signupApi = async (data: verifySignup) => {
    try {
        const response = await instance.post('/seller/signup', data)
        return response;
    } catch (error) {
        console.log(error);
    }
...
export const verifyOtpApi = async (data: verifyOtp) => {
    try {
        const response = await instance.post('/seller/verifyOtp', data)
        return response
    } catch (error) {
        console.log(error);
        throw error;
...
export const resendOtpApi = async (email: string) => {
    try {
        const response = await instance.post('/seller/resendOtp', { email });
        return response;
    } catch (error) {
        console.log(error);
        throw error;
